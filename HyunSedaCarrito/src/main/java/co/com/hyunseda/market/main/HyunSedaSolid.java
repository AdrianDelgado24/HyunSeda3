...
import co.com.hyunseda.market.presentation.GUILOGIN1;
...
public class HyunSedaSolid {
    ...
    public static void main(String[] args) {
       ...
       // GUILOGIN1 guiLogin = new GUILOGIN1(categoryService,service,shoppingCartService);
       ...
       // User user = new User(100000.0,"pepito", "pepe", "perez", "unicauca.edu", "123", "USER"); 
        IUserRepository repositoryU = Factory.getInstance().getUserRepository("default");
        UserService userService = new UserService(repositoryU);
        userService.saveUser("pepito", "pepe", "perez", "unicauca.edu", "123", "USER");
