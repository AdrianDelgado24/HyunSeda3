...
public class ProductService {
    ...
    public boolean saveProduct(String productName,String productDescripcion, double productPrice, int stock, String photo, String productCaracteristc, int categoryId) {
