...
public class GUIELIMINARPRODUCT extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtIdEliminarProduct.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtIdEliminarProductKeyTyped(evt);
            }
        });
    ...
    private void txtIdEliminarProductKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtIdEliminarProductKeyTyped
        char c = evt.getKeyChar();
        if (!Character.isDigit(c)) {
            evt.consume();
        }
    }//GEN-LAST:event_txtIdEliminarProductKeyTyped
