...
public class GUIAGREGARCATEGORIA extends javax.swing.JFrame {
    ...
    private void btnAgregarCategoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarCategoriaActionPerformed
        ...
        try {
            boolean categoriaGuardada = categoryService.saveCategory(nombre);
            System.out.println(categoryService.saveCategory(nombre));
            System.out.println(categoryService.saveCategory(nombre));
            System.out.println(categoryService.saveCategory(nombre));
    ...
    private void addProduct() {
        ...
        String name = txtNombreAgregarCategoria.getText().trim(); 
